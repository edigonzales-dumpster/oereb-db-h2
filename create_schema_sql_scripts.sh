...
#models="OeREBKRM_V1_1;OeREBKRMtrsfr_V1_1;OeREBKRMvs_V1_1;SO_AGI_AV_GB_Administrative_Einteilungen_Publikation_20180822;OeREB_ExtractAnnex_V1_0;DM01AVCH24LV95D;PLZOCH1LV95D"
...
cat sql/init.sql \
sql/*_ili1.sql sql/*_ili2.sql > setup.sql
...
# for schemaname in "arp_npl_oereb" "afu_grundwasserschutz_oereb" "awjf_statische_waldgrenzen_oereb" "ada_denkmalschutz_oereb" "afu_geotope_oereb" "arp_naturreservate_oereb"; do
